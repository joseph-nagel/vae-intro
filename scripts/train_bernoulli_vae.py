...
from varautoenc import MNISTDataModule, DenseVAE, ConvVAE
...
def parse_args():
    ...
    parser.add_argument(
        "--no-batchnorm", dest="batchnorm", action="store_false", help="Do not use batchnorm for conv. layers"
    )
    ...
    parser.add_argument(
        "--same-sigma", dest="per_variable", action="store_false", help="Use same sigma for all variable"
    )
